...
import { authApiService } from "../store/services";
import { toast } from "vue3-toastify";

import "../assets/css/auth-critical.css";
...
const goToLogin = () => router.resolve({ name: "Login" }).href;
      ...
      <div class="authentication-inner">
        ...
        <div class="card px-sm-6 px-0">
          <div class="card-body">
            ...
            <form class="mb-6" @submit.prevent="doRegister">
              <div class="mb-6">
              ...
              <div class="form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input
                    :type="states.revealPassword ? 'text' : 'password'"
                    id="password"
                    class="form-control"
                    name="password"
                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
            ...
            <p class="text-center">
              ...
              <a :href="goToLogin()">
                <span class="text-primary ms-2">Sign in instead</span>
              </a>
            </p>
          </div>
        </div>
