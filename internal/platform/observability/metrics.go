...
func init() {
	...
	reg.MustRegister(SQLOpenConnections)
	reg.MustRegister(SQLInUseConnections)
	reg.MustRegister(SQLWaitCount)
	reg.MustRegister(RedisPoolHits)
	reg.MustRegister(RedisPoolMisses)
	reg.MustRegister(RedisPoolTimeouts)
