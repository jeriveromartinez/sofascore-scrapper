...
type ScraperLeague struct {
	gorm.Model
	Source         string `gorm:"column:source;size:32;not null;default:'fotmob';index:idx_scraper_leagues_source" json:"source"`
	SourceLeagueId string `gorm:"column:source_league_id;size:64;not null;uniqueIndex:idx_scraper_leagues_source_league" json:"source_league_id"`
