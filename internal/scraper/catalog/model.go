...
type ScraperLeague struct {
	...
	SourceLeagueId string `gorm:"column:source_league_id;size:64;not null"`
	...
	Enabled        bool   `gorm:"column:enabled;not null;default:true;index:idx_scraper_leagues_enabled"`
}
